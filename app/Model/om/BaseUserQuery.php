 ...
 * @method UserQuery orderByIsadmin($order = Criteria::ASC) Order by the isadmin column
 * @method UserQuery orderByName($order = Criteria::ASC) Order by the name column
 * @method UserQuery orderByEmail($order = Criteria::ASC) Order by the email column
 * @method UserQuery orderByPassword($order = Criteria::ASC) Order by the password column
 * @method UserQuery orderByConfirmationtoken($order = Criteria::ASC) Order by the confirmationtoken column
 * @method UserQuery orderBySalt($order = Criteria::ASC) Order by the salt column
 * @method UserQuery orderByLastvisit($order = Criteria::ASC) Order by the lastvisit column
 ...
 * @method UserQuery orderByConfirmed($order = Criteria::ASC) Order by the confirmed column
 *
 * @method UserQuery groupById() Group by the id column
 * @method UserQuery groupByIsadmin() Group by the isadmin column
 * @method UserQuery groupByName() Group by the name column
 * @method UserQuery groupByEmail() Group by the email column
 * @method UserQuery groupByPassword() Group by the password column
 * @method UserQuery groupByConfirmationtoken() Group by the confirmationtoken column
 * @method UserQuery groupBySalt() Group by the salt column
 * @method UserQuery groupByLastvisit() Group by the lastvisit column
 ...
 * @method UserQuery groupByConfirmed() Group by the confirmed column
 *
 ...
 *
 * @method UserQuery leftJoinUserSession($relationAlias = null) Adds a LEFT JOIN clause to the query using the UserSession relation
 * @method UserQuery rightJoinUserSession($relationAlias = null) Adds a RIGHT JOIN clause to the query using the UserSession relation
 * @method UserQuery innerJoinUserSession($relationAlias = null) Adds a INNER JOIN clause to the query using the UserSession relation
 *
 * @method User findOne(PropelPDO $con = null) Return the first User matching the query
 * @method User findOneOrCreate(PropelPDO $con = null) Return the first User matching the query, or a new User object populated from the query conditions when no match is found
 *
 * @method User findOneByIsadmin(int $isadmin) Return the first User filtered by the isadmin column
 ...
 * @method User findOneByConfirmationtoken(string $confirmationtoken) Return the first User filtered by the confirmationtoken column
 * @method User findOneBySalt(string $salt) Return the first User filtered by the salt column
 * @method User findOneByLastvisit(string $lastvisit) Return the first User filtered by the lastvisit column
 ...
 * @method User findOneByConfirmed(boolean $confirmed) Return the first User filtered by the confirmed column
 *
 * @method array findById(int $id) Return User objects filtered by the id column
 * @method array findByIsadmin(int $isadmin) Return User objects filtered by the isadmin column
 * @method array findByName(string $name) Return User objects filtered by the name column
 * @method array findByEmail(string $email) Return User objects filtered by the email column
 * @method array findByPassword(string $password) Return User objects filtered by the password column
 * @method array findByConfirmationtoken(string $confirmationtoken) Return User objects filtered by the confirmationtoken column
 * @method array findBySalt(string $salt) Return User objects filtered by the salt column
 * @method array findByLastvisit(string $lastvisit) Return User objects filtered by the lastvisit column
 ...
 * @method array findByConfirmed(boolean $confirmed) Return User objects filtered by the confirmed column
 *
...
abstract class BaseUserQuery extends ModelCriteria
{
     ...
     */
    public function __construct($dbName = 'artcms', $modelName = 'Model\\User', $modelAlias = null)
    {
    ...
    {
        $sql = 'SELECT `id`, `isadmin`, `name`, `email`, `password`, `confirmationtoken`, `salt`, `lastvisit`, `created_at`, `updated_at`, `confirmed` FROM `user` WHERE `id` = :p0';
        try {
     ...
     * Example usage:
     * <code>
     * $query->filterByIsadmin(1234); // WHERE isadmin = 1234
     * $query->filterByIsadmin(array(12, 34)); // WHERE isadmin IN (12, 34)
     * $query->filterByIsadmin(array('min' => 12)); // WHERE isadmin >= 12
     * $query->filterByIsadmin(array('max' => 12)); // WHERE isadmin <= 12
     * </code>
     *
    ...
    public function filterByIsadmin($isadmin = null, $comparison = null)
    {
        if (is_array($isadmin)) {
            ...
            if (isset($isadmin['min'])) {
                $this->addUsingAlias(UserPeer::ISADMIN, $isadmin['min'], Criteria::GREATER_EQUAL);
                $useMinMax = true;
            }
            if (isset($isadmin['max'])) {
                $this->addUsingAlias(UserPeer::ISADMIN, $isadmin['max'], Criteria::LESS_EQUAL);
                $useMinMax = true;
            }
            if ($useMinMax) {
                return $this;
        ...
        return $this->addUsingAlias(UserPeer::ISADMIN, $isadmin, $comparison);
    }
    ...
    /**
     * Filter the query on the confirmationtoken column
     *
     * Example usage:
     * <code>
    ...
    public function filterByConfirmationtoken($confirmationtoken = null, $comparison = null)
    {
        ...
        return $this->addUsingAlias(UserPeer::CONFIRMATIONTOKEN, $confirmationtoken, $comparison);
    }
    ...
    public function filterByLastvisit($lastvisit = null, $comparison = null)
    {
        if (is_array($lastvisit)) {
            ...
            if (isset($lastvisit['min'])) {
                $this->addUsingAlias(UserPeer::LASTVISIT, $lastvisit['min'], Criteria::GREATER_EQUAL);
                $useMinMax = true;
            }
            if (isset($lastvisit['max'])) {
                $this->addUsingAlias(UserPeer::LASTVISIT, $lastvisit['max'], Criteria::LESS_EQUAL);
                $useMinMax = true;
            }
            if ($useMinMax) {
                return $this;
        ...
        return $this->addUsingAlias(UserPeer::LASTVISIT, $lastvisit, $comparison);
    }
    ...
    public function filterByConfirmed($confirmed = null, $comparison = null)
    {
        ...
        return $this->addUsingAlias(UserPeer::CONFIRMED, $confirmed, $comparison);
    }
    ...
    /**
     * Filter the query by a related UserSession object
     *
     * @param   UserSession|PropelObjectCollection $userSession  the related object to use as filter
     * @param     string $comparison Operator to use for the column comparison, defaults to Criteria::EQUAL
     *
     * @return                 UserQuery The current query, for fluid interface
     * @throws PropelException - if the provided filter is invalid.
     */
    public function filterByUserSession($userSession, $comparison = null)
    {
        if ($userSession instanceof UserSession) {
            return $this
                ->addUsingAlias(UserPeer::ID, $userSession->getUserid(), $comparison);
        } elseif ($userSession instanceof PropelObjectCollection) {
            return $this
                ->useUserSessionQuery()
                ->filterByPrimaryKeys($userSession->getPrimaryKeys())
                ->endUse();
        } else {
            throw new PropelException('filterByUserSession() only accepts arguments of type UserSession or PropelCollection');
        }
    }
    ...
    /**
     * Use the UserSession relation UserSession object
     *
     * @see       useQuery()
     *
     * @param     string $relationAlias optional alias for the relation,
     ...
     * @param     string $joinType Accepted values are null, 'left join', 'right join', 'inner join'
     *
     * @return   \Model\UserSessionQuery A secondary query class using the current class as primary query
     */
    public function useUserSessionQuery($relationAlias = null, $joinType = Criteria::INNER_JOIN)
    {
        return $this
            ...
            ->useQuery($relationAlias ? $relationAlias : 'UserSession', '\Model\UserSessionQuery');
    }

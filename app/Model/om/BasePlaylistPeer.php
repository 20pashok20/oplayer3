...
use Model\UserPeer;
use Model\map\PlaylistTableMap;
 ...
 */
abstract class BasePlaylistPeer
{
    ...
    protected static $fieldNames = array (
        BasePeer::TYPE_PHPNAME => array ('Id', 'Userid', 'Name', 'Position', 'Cnt', ),
        BasePeer::TYPE_STUDLYPHPNAME => array ('id', 'userid', 'name', 'position', 'cnt', ),
        BasePeer::TYPE_COLNAME => array (PlaylistPeer::ID, PlaylistPeer::USERID, PlaylistPeer::NAME, PlaylistPeer::POSITION, PlaylistPeer::CNT, ),
        BasePeer::TYPE_RAW_COLNAME => array ('ID', 'USERID', 'NAME', 'POSITION', 'CNT', ),
        BasePeer::TYPE_FIELDNAME => array ('id', 'userId', 'name', 'position', 'cnt', ),
    ...
    protected static $fieldKeys = array (
        BasePeer::TYPE_PHPNAME => array ('Id' => 0, 'Userid' => 1, 'Name' => 2, 'Position' => 3, 'Cnt' => 4, ),
        BasePeer::TYPE_STUDLYPHPNAME => array ('id' => 0, 'userid' => 1, 'name' => 2, 'position' => 3, 'cnt' => 4, ),
        BasePeer::TYPE_COLNAME => array (PlaylistPeer::ID => 0, PlaylistPeer::USERID => 1, PlaylistPeer::NAME => 2, PlaylistPeer::POSITION => 3, PlaylistPeer::CNT => 4, ),
        BasePeer::TYPE_RAW_COLNAME => array ('ID' => 0, 'USERID' => 1, 'NAME' => 2, 'POSITION' => 3, 'CNT' => 4, ),
        BasePeer::TYPE_FIELDNAME => array ('id' => 0, 'userId' => 1, 'name' => 2, 'position' => 3, 'cnt' => 4, ),
        BasePeer::TYPE_NUM => array (0, 1, 2, 3, 4, )
    );
    ...
    public static function addSelectColumns(Criteria $criteria, $alias = null)
    {
        if (null === $alias) {
            ...
            $criteria->addSelectColumn(PlaylistPeer::USERID);
            $criteria->addSelectColumn(PlaylistPeer::NAME);
            $criteria->addSelectColumn(PlaylistPeer::POSITION);
            $criteria->addSelectColumn(PlaylistPeer::CNT);
        } else {
    ...
    {
        // Invalidate objects in PlaylistTrackPeer instance pool,
    ...
    public static function doCountJoinUser(Criteria $criteria, $distinct = false, PropelPDO $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        ...
        $criteria->addJoin(PlaylistPeer::USERID, UserPeer::ID, $join_behavior);
    ...
    /**
     * Selects a collection of Playlist objects pre-filled with their User objects.
     * @param      Criteria  $criteria
     * @param      PropelPDO $con
     * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
    ...
    public static function doSelectJoinUser(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        ...
        while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
            ...
            if ($key2 !== null) {
                ...
                // Add the $obj1 (Playlist) to $obj2 (User)
    ...
    public static function doSelectJoinAll(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        ...
        while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
            ...
            if ($key2 !== null) {
                ...
                // Add the $obj1 (Playlist) to the collection in $obj2 (User)
                $obj2->addPlaylist($obj1);
    ...
    public static function doInsert($values, PropelPDO $con = null)
    {
        ...
        if ($criteria->containsKey(PlaylistPeer::ID) && $criteria->keyContainsValue(PlaylistPeer::ID) ) {
